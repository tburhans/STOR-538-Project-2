...
```{r}
ALL_GAMES_DONE_AGAIN<-mutate(ALL_GAMES_DONE_AGAIN, Home_Possesions= (FGA_home-OREB_home+TO_home+(.4*FTA_home)), Away_Possesions=FGA_away-OREB_away+TO_away+(.4*FTA_away))
ALL_GAMES_DONE_AGAIN<-mutate(ALL_GAMES_DONE_AGAIN,Home_PPP= PTS_home/Home_Possesions, Away_PPP=PTS_away/Away_Possesions)
```
